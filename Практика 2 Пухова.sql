...
where date(payment_date) between '2005-06-17' and '2005-06-19' and amount >1 order by payment_date; 
...
select payment_date from payment order by payment_date desc limit 10;
...
character_length(email) as "Длина", date(last_update) as "Дата" 
from customer; 
